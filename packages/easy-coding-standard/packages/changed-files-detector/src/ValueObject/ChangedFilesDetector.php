...
namespace Symplify\EasyCodingStandard\ChangedFilesDetector\ValueObject;
...
final class ChangedFilesDetector
{
    ...
    public function __construct(FileHashComputer $fileHashComputer, \Symfony\Component\Cache\Adapter\TagAwareAdapterInterface $tagAwareAdapter)
    {
