...
final class ConflictingCheckersCompilerPass implements CompilerPassInterface
{
     ...
     * @var string[][]
     */
    private const CONFLICTING_CHECKER_GROUPS = [[DisallowYodaComparisonSniff::class, YodaStyleFixer::class], [LowerCaseConstantSniff::class, UpperCaseConstantSniff::class], [LowercaseConstantsFixer::class, UpperCaseConstantSniff::class], [ConstantCaseFixer::class, UpperCaseConstantSniff::class], [DeclareStrictTypesSniff::class, DeclareEqualNormalizeFixer::class], [DeclareStrictTypesSniff::class, BlankLineAfterOpeningTagFixer::class], [FileHeaderSniff::class, NoBlankLinesAfterPhpdocFixer::class]];
