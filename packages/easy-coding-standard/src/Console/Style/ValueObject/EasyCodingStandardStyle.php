...
namespace Symplify\EasyCodingStandard\Console\Style\ValueObject;
...
final class EasyCodingStandardStyle extends SymfonyStyle
{
     ...
     */
    private $terminal;
    public function __construct(InputInterface $input, OutputInterface $output, \Symfony\Component\Console\Terminal $terminal)
    {
