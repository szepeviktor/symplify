...
namespace Symplify\EasyCodingStandard\Console\Output\ValueObject;

use Symplify\EasyCodingStandard\Configuration\ValueObject\OutputFormatterNotFoundException;
...
final class OutputFormatterCollector
{
    ...
    public function getByName(string $name): OutputFormatterInterface
    {
        ...
        throw new OutputFormatterNotFoundException(sprintf('Output formatter "%s" not found. Use one of: "%s".', $name, implode('", "', array_keys($this->outputFormatters))));
    }
}
