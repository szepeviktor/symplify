...
namespace Symplify\MonorepoBuilder\Utils\ValueObject;
...
final class VersionUtils
{
    ...
    public function __construct(ParameterProvider $parameterProvider, \Symplify\MonorepoBuilder\ValueObjectFactory\VersionFactory $versionFactory)
    {
