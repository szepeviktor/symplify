...
namespace Symplify\MonorepoBuilder\Merge\ComposerJsonDecorator\ValueObject;
...
final class SortComposerJsonDecorator implements ComposerJsonDecoratorInterface
{
    ...
    public function decorate(ComposerJson $composerJson): void
    {
        ...
        usort($orderedKeys, function ($key1, $key2): int {
            return array_search($key1, $this->sectionOrder, true) <=> array_search($key2, $this->sectionOrder, true);
        });
