...
namespace Symplify\MonorepoBuilder\Merge\Configuration\ValueObject;
...
final class ModifyingComposerJsonProvider
{
    ...
    public function __construct(\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, ParameterProvider $parameterProvider)
    {
