...
namespace Symplify\MonorepoBuilder\Split\FileSystem\ValueObject;
...
final class DirectoryToRepositoryProvider
{
    ...
    public function __construct(ParameterProvider $parameterProvider, FileSystemGuard $fileSystemGuard, StringFormatConverter $stringFormatConverter)
    {
    ...
    public function provide(): array
    {
        ...
        $directoriesToRepositories = $this->parameterProvider->provideArrayParameter(Option::DIRECTORIES_TO_REPOSITORIES);
    ...
    {
        $extractMessage = sprintf('Check "%s" parameter in your config.', Option::class . '::DIRECTORIES_TO_REPOSITORIES');
    ...
    {
        $convertFormat = $this->parameterProvider->provideStringParameter(Option::DIRECTORIES_TO_REPOSITORIES_CONVERT_FORMAT);
