...
namespace Symplify\MonorepoBuilder\Release\Guard\ValueObject;

use PharIo\Version\Version;
use Symplify\MonorepoBuilder\ValueObject\Git\InvalidGitVersionException;
use Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface;
use Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\StageAwareInterface;
use Symplify\MonorepoBuilder\Release\ValueObject\ConfigurationException;
...
final class ReleaseGuard
{
     ...
     */
    public function __construct(GitManager $gitManager, array $releaseWorkers, ParameterProvider $parameterProvider)
    {
