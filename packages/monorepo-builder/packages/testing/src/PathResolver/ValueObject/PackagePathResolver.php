...
namespace Symplify\MonorepoBuilder\Testing\PathResolver\ValueObject;
...
final class PackagePathResolver
{
    ...
    private function resolveRelativeDirectoryToRoot(SmartFileInfo $rootComposerFileInfo, SmartFileInfo $packageComposerFileInfo): string
    {
