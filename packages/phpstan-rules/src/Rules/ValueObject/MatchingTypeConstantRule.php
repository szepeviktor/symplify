...
use Symplify\PHPStanRules\PhpDoc\ValueObject\BarePhpDocParser;
...
final class MatchingTypeConstantRule extends AbstractSymplifyRule
{
     ...
     */
    private const TYPE_NODES_TO_ACCEPTED_TYPES = [LNumber::class => ['int'], DNumber::class => ['float', 'double'], String_::class => ['string'], ConstFetch::class => ['bool']];
    /**
     * @var array<string, string>
     */
    private const TYPE_CLASS_TO_STRING_TYPE = [String_::class => 'string', LNumber::class => 'int', DNumber::class => 'float', ConstFetch::class => 'bool'];
    /**
     * @var \Symplify\PHPStanRules\PhpDoc\ValueObject\BarePhpDocParser
     */
...
CODE_SAMPLE
    ...
    private function resolveOnlyVarAnnotationType(\PhpParser\Node\Stmt\ClassConst $classConst): ?string
    {
