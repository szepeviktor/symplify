...
use Symplify\PHPStanRules\ValueObject\NodeComparator;
...
final class NoParentMethodCallOnNoOverrideProcessRule extends AbstractSymplifyRule
{
    ...
    /**
     * @var \Symplify\PHPStanRules\ValueObject\NodeComparator
     */
...
CODE_SAMPLE
    ...
    private function isParentSelfMethodStaticCall(Node $node, \PhpParser\Node\Stmt\ClassMethod $classMethod): bool
    {
    ...
    private function resolveOnlyNode(\PhpParser\Node\Stmt\ClassMethod $classMethod): ?Node
    {
