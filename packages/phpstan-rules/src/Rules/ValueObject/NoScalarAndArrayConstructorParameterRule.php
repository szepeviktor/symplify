...
use Symplify\Autodiscovery\ValueObject\Discovery;
use Symplify\Autodiscovery\Finder\ValueObject\AutodiscoveryFinder;
use Symplify\FlexLoader\Flex\ValueObject\FlexLoader;
use Symplify\PHPStanRules\Types\ValueObject\ScalarTypeAnalyser;
use Symplify\PHPStanRules\ValueObject\VariableAsParamAnalyser;
...
final class NoScalarAndArrayConstructorParameterRule extends AbstractSymplifyRule
{
    ...
    /**
     * @var \Symplify\PHPStanRules\ValueObject\VariableAsParamAnalyser
     */
    private $variableAsParamAnalyser;
    /**
     * @var \Symplify\PHPStanRules\Types\ValueObject\ScalarTypeAnalyser
     */
    private $scalarTypeAnalyser;
    public function __construct(VariableAsParamAnalyser $variableAsParamAnalyser, ScalarTypeAnalyser $scalarTypeAnalyser)
    {
