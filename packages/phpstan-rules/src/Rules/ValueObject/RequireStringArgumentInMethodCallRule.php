...
CODE_SAMPLE
, ['stringArgByMethodByType' => ['SomeClass' => ['someMethod' => [0]]]])]);
    }
    /**
     * @param array<string, array<int>> $positionsByMethods
     */
    private function matchPositions(\PhpParser\Node\Expr\MethodCall $methodCall, Scope $scope, string $desiredType, array $positionsByMethods, string $methodName): ?array
    {
    ...
    private function isNodeVarType(\PhpParser\Node\Expr\MethodCall $methodCall, Scope $scope, string $desiredType): bool
    {
