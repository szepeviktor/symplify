...
final class TooDeepNewClassNestingRule extends AbstractSymplifyRule implements ConfigurableRuleInterface
{
    ...
    public function __construct(\PhpParser\NodeFinder $nodeFinder, int $maxNewClassNesting = 3)
    {
    ...
    {
        $countNew = count($this->nodeFinder->findInstanceOf($node, \PhpParser\Node\Expr\New_::class));
