...
final class SeeAnnotationToTestRule extends AbstractSymplifyRule implements ConfigurableRuleInterface
{
     ...
     */
    public function __construct(\PHPStan\Broker\Broker $broker, \PHPStan\Type\FileTypeMapper $fileTypeMapper, array $requiredSeeTypes = [])
    {
...
, ['requiredSeeTypes' => ['Rule']])]);
    ...
    private function matchClassReflection(\PhpParser\Node\Stmt\Class_ $class): ?ClassReflection
    {
