...
use Symplify\PHPStanRules\NodeAnalyzer\ValueObject\SymfonyPhpConfigClosureAnalyzer;
...
final class ForbiddenComplexArrayConfigInSetRule extends AbstractSymplifyRule
{
    ...
    /**
     * @var \Symplify\PHPStanRules\NodeAnalyzer\ValueObject\SymfonyPhpConfigClosureAnalyzer
     */
    ...
    public function process(Node $node, Scope $scope): array
    {
        ...
        foreach ($valueArray->items as $nestedItem) {
            if (!$nestedItem instanceof \PhpParser\Node\Expr\ArrayItem) {
                continue;
            }
            // way too complex
