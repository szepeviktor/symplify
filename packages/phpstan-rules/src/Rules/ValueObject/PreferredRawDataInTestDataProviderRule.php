...
CODE_SAMPLE
    ...
    private function findDataProviderClassMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod, string $methodName): ?\PhpParser\Node\Stmt\ClassMethod
    {
    ...
    private function matchDataProviderMethodName(\PhpParser\Node\Stmt\ClassMethod $classMethod): ?string
    {
    ...
    private function isSkipped(\PhpParser\Node\Stmt\ClassMethod $classMethod, Scope $scope): bool
    {
