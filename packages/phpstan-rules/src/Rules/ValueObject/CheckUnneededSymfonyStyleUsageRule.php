...
use Symplify\PHPStanRules\NodeAnalyzer\ValueObject\ClassMethodsNodeAnalyzer;
...
final class CheckUnneededSymfonyStyleUsageRule extends AbstractSymplifyRule
{
    ...
    /**
     * @var \Symplify\PHPStanRules\NodeAnalyzer\ValueObject\ClassMethodsNodeAnalyzer
     */
    private $classMethodsNodeAnalyzer;
    public function __construct(SimpleNameResolver $simpleNameResolver, ClassMethodsNodeAnalyzer $classMethodsNodeAnalyzer)
    {
    ...
    public function process(Node $node, Scope $scope): array
    {
        ...
        $symfonyStyleMethodCalls = $this->classMethodsNodeAnalyzer->resolveMethodCallsByType($node, SymfonyStyle::class);
...
CODE_SAMPLE
    ...
    private function hasParentClassSymfonyStyle(\PhpParser\Node\Stmt\ClassLike $classLike): bool
    {
