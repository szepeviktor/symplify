...
final class ForbiddenNewInMethodRule extends AbstractSymplifyRule implements ConfigurableRuleInterface
{
     ...
     */
    public function __construct(\PhpParser\NodeFinder $nodeFinder, array $forbiddenClassMethods = [])
    {
...
CODE_SAMPLE
, ['forbiddenClassMethods' => [Rule::class => ['getRule']]])]);
    }
    private function hasNewInside(\PhpParser\Node\Stmt\ClassMethod $classMethod): bool
    {
