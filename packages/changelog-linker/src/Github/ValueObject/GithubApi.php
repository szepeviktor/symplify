...
namespace Symplify\ChangelogLinker\Github\ValueObject;
...
use Symplify\ChangelogLinker\ValueObject\Github\GithubApiException;
use Symplify\ChangelogLinker\Guzzle\ValueObject\ResponseFormatter;
...
final class GithubApi
{
    ...
    private $client;
    /**
     * @var \Symplify\ChangelogLinker\Guzzle\ValueObject\ResponseFormatter
     */
    private $responseFormatter;
    public function __construct(\GuzzleHttp\ClientInterface $client, ParameterProvider $parameterProvider, ResponseFormatter $responseFormatter)
    {
        $this->client = $client;
