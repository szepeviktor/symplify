...
final class ChangelogDumper
{
    ...
    public function __construct(GitCommitDateTagResolver $gitCommitDateTagResolver, ChangelogFormatter $changelogFormatter)
    {
     ...
     */
    public function reportChangesWithHeadlines(array $changes, bool $withCategories, bool $withPackages, ?string $priority): string
    {
    ...
    private function displayHeadlines(bool $withCategories, bool $withPackages, ?string $priority, Change $change): void
    {
