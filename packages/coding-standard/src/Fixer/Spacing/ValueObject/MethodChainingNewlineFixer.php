...
namespace Symplify\CodingStandard\Fixer\Spacing\ValueObject;
...
final class MethodChainingNewlineFixer extends AbstractSymplifyFixer implements DocumentedRuleInterface
{
    ...
    public function __construct(\PhpCsFixer\WhitespacesFixerConfig $whitespacesFixerConfig, BlockFinder $blockFinder)
    {
