...
namespace Symplify\CodingStandard\Fixer\ArrayNotation\ValueObject;
...
use Symplify\CodingStandard\TokenRunner\Transformer\FixerTransformer\ValueObject\LineLengthTransformer;
...
final class StandaloneLineInMultilineArrayFixer extends AbstractArrayFixer implements DocumentedRuleInterface
{
    ...
    /**
     * @var \Symplify\CodingStandard\TokenRunner\Transformer\FixerTransformer\ValueObject\LineLengthTransformer
     */
    ...
    public function __construct(LineLengthTransformer $lineLengthTransformer, \Symplify\CodingStandard\TokenRunner\Wrapper\FixerWrapper\ArrayWrapperFactory $arrayWrapperFactory)
    {
