...
namespace Symplify\CodingStandard\Sniffs\Debug\ValueObject;
 ...
 */
final class CommentedOutCodeSniff extends \PHP_CodeSniffer\Standards\Squiz\Sniffs\PHP\CommentedOutCodeSniff implements DocumentedRuleInterface
{
    /**
     * @return int[]
     */
    ...
    {
        return new RuleDefinition('There should be no commented code. Git is good enough for versioning', [new CodeSample(<<<'CODE_SAMPLE'
// $one = 1;
// $two = 2;
// $three = 3;
CODE_SAMPLE
