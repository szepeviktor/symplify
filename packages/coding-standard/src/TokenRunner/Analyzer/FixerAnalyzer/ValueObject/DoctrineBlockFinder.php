...
use Symplify\CodingStandard\ValueObject\EdgeFindingException;
use Symplify\CodingStandard\TokenRunner\ValueObject\MissingImplementationException;
...
final class DoctrineBlockFinder
{
    ...
    {
        $this->docBlockEdgeDefinitions = [new DocBlockEdgeDefinition(self::BLOCK_TYPE_CURLY_BRACE, '{', '}'), new DocBlockEdgeDefinition(self::BLOCK_TYPE_PARENTHESIS_BRACE, '(', ')')];
    }
    /**
