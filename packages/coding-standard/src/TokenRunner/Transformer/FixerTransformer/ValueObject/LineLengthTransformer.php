...
use Symplify\CodingStandard\TokenRunner\Analyzer\FixerAnalyzer\ValueObject\IndentDetector;
...
final class LineLengthTransformer
{
    ...
    /**
     * @var \Symplify\CodingStandard\TokenRunner\Analyzer\FixerAnalyzer\ValueObject\IndentDetector
     */
    ...
    /**
     * @var \Symplify\CodingStandard\TokenRunner\Transformer\FixerTransformer\ValueObject\LineLengthResolver
     */
    private $lineLengthResolver;
    /**
     * @var \Symplify\CodingStandard\TokenRunner\Transformer\FixerTransformer\ValueObject\TokensInliner
     */
    private $tokensInliner;
    /**
     * @var \Symplify\CodingStandard\TokenRunner\Transformer\FixerTransformer\ValueObject\FirstLineLengthResolver
     */
    private $firstLineLengthResolver;
    /**
     * @var \Symplify\CodingStandard\TokenRunner\Transformer\FixerTransformer\ValueObject\LineLengthCloserTransformer
     */
    private $lineLengthCloserTransformer;
    /**
     * @var \Symplify\CodingStandard\TokenRunner\Transformer\FixerTransformer\ValueObject\LineLengthOpenerTransformer
     */
    private $lineLengthOpenerTransformer;
    public function __construct(IndentDetector $indentDetector, TokenSkipper $tokenSkipper, \PhpCsFixer\WhitespacesFixerConfig $whitespacesFixerConfig, LineLengthResolver $lineLengthResolver, TokensInliner $tokensInliner, FirstLineLengthResolver $firstLineLengthResolver, LineLengthCloserTransformer $lineLengthCloserTransformer, LineLengthOpenerTransformer $lineLengthOpenerTransformer)
    {
