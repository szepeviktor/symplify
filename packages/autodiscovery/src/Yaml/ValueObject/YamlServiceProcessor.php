...
final class YamlServiceProcessor
{
    ...
    /**
     * @var \Symplify\Autodiscovery\Yaml\ValueObject\TagAnalyzer
     */
    private $tagAnalyzer;
    /**
     * @var ServiceConfig
     ...
     * @return mixed[]|mixed
     */
    public function process(array $yaml, $service, string $name, string $filter, \Symplify\Autodiscovery\ValueObject\ServiceConfig $serviceConfig): array
    {
