...
namespace Symplify\ConsoleColorDiff\Console\Output\ValueObject;
...
final class ConsoleDiffer
{
    ...
    public function __construct(\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \SebastianBergmann\Diff\Differ $differ, ColorConsoleDiffFormatter $colorConsoleDiffFormatter)
    {
