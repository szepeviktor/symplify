...
namespace Symplify\SymfonyStaticDumper\Tests\TestProject\HttpKernel\ValueObject;
...
use Symplify\SymfonyStaticDumper\ValueObject\SymfonyStaticDumperBundle;
final class TestSymfonyStaticDumperKernel extends Kernel
{
    use MicroKernelTrait;
    /**
     * @var \Symplify\FlexLoader\Flex\ValueObject\FlexLoader
     */
    private $flexLoader;
    /**
     * @var \Symplify\Autodiscovery\ValueObject\Discovery
     */
    private $discovery;
    ...
    /**
     * @return FrameworkBundle[]|TwigBundle[]|\Symplify\SymfonyStaticDumper\ValueObject\SymfonyStaticDumperBundle[]
     */
