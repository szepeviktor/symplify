...
namespace Symplify\SymfonyStaticDumper\HttpFoundation\ValueObject;
...
final class ControllerContentResolver
{
    ...
    public function __construct(\Psr\Container\ContainerInterface $container, \Symfony\Component\HttpFoundation\RequestStack $requestStack, ControllerMatcher $controllerMatcher)
    {
