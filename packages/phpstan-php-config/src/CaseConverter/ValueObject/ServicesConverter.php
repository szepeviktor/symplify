...
namespace Symplify\PHPStanPHPConfig\CaseConverter\ValueObject;

use Psr\Container\ContainerInterface;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\DependencyInjection\Definition;
use Symplify\PHPStanPHPConfig\Reflection\ValueObject\ConstructorParameterNameResolver;
use Symplify\SymplifyKernel\ValueObject\ShouldNotHappenException;
final class ServicesConverter
{
    /**
     * @var \Symplify\PHPStanPHPConfig\Reflection\ValueObject\ConstructorParameterNameResolver
     */
    ...
    private function convertServiceArguments(Definition $serviceDefinition, string $serviceClass): array
    {
        ...
        foreach ($serviceDefinition->getArguments() as $key => $value) {
            ...
            $argumentName = $this->constructorParameterNameResolver->resolveFromClassAndArgumentPosition($serviceClass, $key);
