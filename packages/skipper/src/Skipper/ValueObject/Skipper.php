...
namespace Symplify\Skipper\Skipper\ValueObject;
...
use Symplify\Skipper\FileSystem\ValueObject\PathNormalizer;
...
final class Skipper
{
    ...
    private $skipRules;
    /**
     * @var \Symplify\Skipper\FileSystem\ValueObject\PathNormalizer
     */
    private $pathNormalizer;
    /**
     * @var \Symplify\PackageBuilder\Reflection\ValueObject\ClassLikeExistenceChecker
     */
    private $classLikeExistenceChecker;
    public function __construct(ParameterProvider $parameterProvider, SkipRulesFactory $skipRulesFactory, PathNormalizer $pathNormalizer, ClassLikeExistenceChecker $classLikeExistenceChecker)
    {
